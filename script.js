...
// //typy złożone - 2 :obiekt i tablica
...
// //Element.classList.add("jakaś klasa")

// //tablice - referencje-/
// //tablice//
// //zapis es6
// const user = ["anna","Jan","Ola","Pola","K"];
// //starszy zapis
// const nums = new Array(3,4,5,6);

// console.log(user);

// // //dwa rodzaje metod tablicowych, jedne zmieniaja oryginal, a drugie tworza kopie - mutowalne i nie mutowalne/
// // user.push("Nowy");
// // user.push("Kolejny");
// // user.pop();
// // user.sort();

// // const test = user.filter( (user) => user.includes("w"));

// // user.forEach( (user) => console.log(`To jest ${user}`));

// // user.forEach();

// // //console.log( user[user.lenght - 1]);
// // console.log(user,test)

// // //różnica forEach a formap//
...
//     const title = document.createComment("h3");
...
//funkcja asynchroniczna// - trudna rzecz-
const getData = async () => {
